    ...
    <nav class="bg-gray-900 border-b-2 border-white">
        <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <a href="home.php" class="flex items-center space-x-3 order-1 ml-6">
                <img src="logo.png" class="h-20" alt="Casino Logo" />
            </a>
            ...
            <div class="flex items-center justify-center space-x-4 order-2 md:order-3">
                ...
                <a href="profiel.php" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300" id="user-menu-button">
                    <img class="w-16 h-16 rounded-full hover:border hover:border-white hover:p-1" src="profiel_foto.png" alt="User Photo">
                </a>
                ...
                <div class="flex items-center justify-center h-full">
                    <a href="logout.php" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-500 transition">Logout</a>
                </div>
            </div>
        </div>
    </nav>
                    ...
                    <div class="flex align-center justify-center p-4">
                        <form method="POST">
                            <table class="table-auto">
                                <tr>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="0.01"><img alt="muntje" src="plaatjes/casino_1.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="0.05"><img alt="muntje" src="plaatjes/casino_5.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="0.10"><img alt="muntje" src="plaatjes/casino_10.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="0.25"><img alt="muntje" src="plaatjes/casino_25.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="1.00"><img alt="muntje" src="plaatjes/casino_100.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="5.00"><img alt="muntje" src="plaatjes/casino_500.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                    <td class="p-2">
                                        <button type="submit" name="inzet" value="10.00"><img alt="muntje" src="plaatjes/casino_1000.png" class="h-20 w-20 object-contain"></button>
                                    </td>
                                </tr>
                            </table>
                        </form>
