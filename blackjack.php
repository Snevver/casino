                    ...
                    <div class="grid grid-cols-2 gap-6 border border-white rounded-lg bg-black p-6">
                        ...
                        <div class="flex justify-center items-center flex-col">
                            ...
                            <div class="flex justify-center items-center gap-2 flex-row flex-wrap">
                                <?php
                                    echo "<img src='speelkaarten/{$_SESSION['dealer_kaarten'][0]}.png' alt='Dealer kaart' class='h-52 max-w-full object-contain'>";
                                    echo $_SESSION['spel_klaar']
                                    ? "<img src='speelkaarten/{$_SESSION['dealer_kaarten'][1]}.png' alt='Dealer kaart' class='h-52 max-w-full object-contain'>"
                                    : "<img src='speelkaarten/mystery.png' alt='Mystery kaart' class='h-52 max-w-full object-contain'>";
                                    for ($i = 2; $i < count($_SESSION['dealer_kaarten']); $i++) {
                                    echo "<img src='speelkaarten/{$_SESSION['dealer_kaarten'][$i]}.png' alt='Dealer kaart' class='h-52 max-w-full object-contain'>";
                                    }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-center items-center flex-col">
                            ...
                            <div class="flex justify-center items-center flex-wrap gap-2">
                                <?php
                                    ...
                                    echo "<img src='speelkaarten/{$player_card}.png' alt='Speler kaart' class='h-52 max-w-full object-contain'>";
                                    }
                                ?>
                            </div>
                        </div>
